            ...
            {result.parcelError ? (
              ...
              <>
                <EmptyState
                  ...
                  desc="Couldn't find a confident match in NYC's PLUTO dataset for this address. Double-check the address, or look it up directly on NYC's own Property Information Portal."
                />
